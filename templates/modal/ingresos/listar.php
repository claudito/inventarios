...
<div class="panel panel-default">
  ...
  foreach ($ingresos->lista() as $key => $value) 
  {
  ?>
  <tr>
  <td>
  <?php if ($value['estado']=='00'): ?>
   <a href="ingresodet?documento=<?php echo $value['documento']; ?>&tipo=NI"><?php echo $value['documento']; ?>
  </a> 
  <?php else: ?>
  <a href="../PDF/reporte/ni?numero=<?php echo $value['documento']; ?>&tipo=NI" target="_blank"><?php echo $value['documento']; ?>
  <?php endif ?>
  </td>
...
<!-- Modal -->
  <script>
    $(".btn-edit").click(function(){
      ...
      tipo        = $(this).data("tipo");
      $.get("../templates/modal/ingresos/actualizar.php","documento="+documento+"&tipo="+tipo,function(data){
        $("#form-edit").html(data);
      });
