...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo PATH; ?>"><i class="fa fa-paw"></i> INVENTARIOS</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      echo '<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">'. $value_lista_menu['descripcion'].'<span class="caret"></span></a>';
      echo '<ul class="dropdown-menu">';
       
      $submenu  =  new Submenu();
      $lista_sub_menu = $submenu->lista_menu($value_lista_menu['idmenu'],$_SESSION[KEY.USUARIO]);
      
      if (count($lista_sub_menu)>0)
      {
      ...
      {
       echo '<li><a href="#">NO HAY SUB MENÚS ASOCIADOS</a></li>';
      }
