...
function lista()
{
  ...
  c.direccion,c.comentario,u.nombres,u.apellidos,c.estado FROM movalmcab as c  INNER JOIN usuarios as u ON c.usuarios_idusuarios=u.idusuarios WHERE c.tipo='NI'";
  $result   = $conexion->query($query);
